...
function App() {
  ...
  useEffect(() => {
    setInterval(() => {
      if (renderCount.current < myArray.length) {
        setCurrentText(myArray[renderCount.current])
        renderCount.current++
      }
    }, 300);
